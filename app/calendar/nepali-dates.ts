...
export class NepaliYear {
    ...
    static GetAllNepaliYears(): Array<NepaliYear> {
        ...
        nepYears.push({ yearNumber: 1900, yearNumberNep: "१९८०" });
        ...
        nepYears.push({ yearNumber: 2000, yearNumberNep: "२०१०" });
        ...
        nepYears.push({ yearNumber: 2000, yearNumberNep: "२०२०" });
        ...
        nepYears.push({ yearNumber: 2000, yearNumberNep: "२०४०" });
        ...
        nepYears.push({ yearNumber: 2000, yearNumberNep: "२०८०" });
