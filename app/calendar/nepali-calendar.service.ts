...
export class NepaliCalendarService {
    ...
    private yr_mth: Array<Array<number>>;
    private nep_mth_Dates: Array<number>;

    private minNepYear: number = 1970;
    private maxNepYear: number = 2090;

    private minEngYear: number = 0;
    private maxEngYear: number = 0;


    constructor() {
        this.LoadNepYear_MthHash();
    }

    LoadNepYear_MthHash() {
        //this array contains How many days were there in each months of Nepali Years
        ///data from 1950 to 2000 are not verified: sudarshan15Jul2017
        this.yr_mth = new Array<any>();
        this.yr_mth[1950] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[1951] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1952] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1953] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30];
        this.yr_mth[1954] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[1955] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1956] = [31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1957] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[1958] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[1959] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1960] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1961] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[1962] = [30, 32, 31, 32, 31, 31, 29, 30, 29, 30, 29, 31];
        this.yr_mth[1963] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1964] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1965] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[1966] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31];
        this.yr_mth[1967] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1968] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1969] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[1970] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30];
        this.yr_mth[1971] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1972] = [31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1973] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[1974] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1975] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1976] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30];
        this.yr_mth[1977] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[1978] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1979] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[1980] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30];
        this.yr_mth[1981] = [31, 31, 32, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1982] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1983] = [31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1984] = [31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1985] = [31, 32, 31, 32, 30, 31, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1986] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1987] = [31, 31, 32, 31, 31, 31, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1988] = [30, 31, 32, 32, 30, 31, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1989] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1990] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1991] = [31, 31, 32, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1992] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1993] = [31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1994] = [31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1995] = [31, 32, 31, 32, 30, 31, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1996] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1997] = [31, 31, 32, 31, 31, 31, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1998] = [30, 31, 32, 32, 30, 31, 30, 30, 29, 30, 30, 30];
        this.yr_mth[1999] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        ///data below this are verified, but not above this.. 
        this.yr_mth[2000] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[2001] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2002] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2003] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2004] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[2005] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2006] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2007] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2008] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31];
        this.yr_mth[2009] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2010] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2011] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2012] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30];
        this.yr_mth[2013] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2014] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2015] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2016] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30];
        this.yr_mth[2017] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2018] = [31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2019] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[2020] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2021] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2022] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30];
        this.yr_mth[2023] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[2024] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2025] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2026] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2027] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[2028] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2029] = [31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2030] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2031] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[2032] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2033] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2034] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2035] = [30, 32, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31];
        this.yr_mth[2036] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2037] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2038] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2039] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30];
        this.yr_mth[2040] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2041] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2042] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2043] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30];
        this.yr_mth[2044] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2045] = [31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2046] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2047] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2048] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2049] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30];
        this.yr_mth[2050] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[2051] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2052] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2053] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30];
        this.yr_mth[2054] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[2055] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2056] = [31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2057] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2058] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[2059] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2060] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2061] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2062] = [30, 32, 31, 32, 31, 31, 29, 30, 29, 30, 29, 31];
        this.yr_mth[2063] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2064] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2065] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2066] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31];
        this.yr_mth[2067] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2068] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2069] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2070] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30];
        this.yr_mth[2071] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2072] = [31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2073] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31];
        this.yr_mth[2074] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2075] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2076] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30];
        this.yr_mth[2077] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31];
        this.yr_mth[2078] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2079] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30];
        this.yr_mth[2080] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30];
        this.yr_mth[2081] = [31, 31, 32, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[2082] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[2083] = [31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[2084] = [31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[2085] = [31, 32, 31, 32, 30, 31, 30, 30, 29, 30, 30, 30];
        this.yr_mth[2086] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[2087] = [31, 31, 32, 31, 31, 31, 30, 30, 29, 30, 30, 30];
        this.yr_mth[2088] = [30, 31, 32, 32, 30, 31, 30, 30, 29, 30, 30, 30];
        this.yr_mth[2089] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];
        this.yr_mth[2090] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30];

    }

    GetDaysOfMonth(yrNo: number, mthNo: number): Array<NepaliDay> {
        //get current year's data from hash.
        let yrMonths = this.yr_mth[yrNo];
        //get current month's day count (mth-1) since index starts from 0.
        let mthMaxDays = yrMonths[mthNo - 1];
    ...
    public ConvertEngToNepDate(engDate: string): NepaliDate {
        ...
        let engYY: number = dateObject.years;
    ...
    private GetNepaliCalendarYearInfo(): Array<any> {
        let calYear = [
            ...
            { CYear: 2086, YearStart: "Apr 14 2029", YearEnd: "Apr 13 1930" },
            { CYear: 2087, YearStart: "Apr 14 2030", YearEnd: "Apr 14 1931" },
            { CYear: 2088, YearStart: "Apr 15 2031", YearEnd: "Apr 13 1932" },
            { CYear: 2089, YearStart: "Apr 14 2032", YearEnd: "Apr 13 1933" },
            { CYear: 2090, YearStart: "Apr 14 2033", YearEnd: "Apr 13 1934" },
            { CYear: 2091, YearStart: "Apr 14 2034", YearEnd: "Apr 14 1935" },
            { CYear: 2092, YearStart: "Apr 15 2035", YearEnd: "Apr 13 1936" },
            { CYear: 2093, YearStart: "Apr 14 2036", YearEnd: "Apr 13 1937" },
            { CYear: 2094, YearStart: "Apr 14 2037", YearEnd: "Apr 13 1938" },
            { CYear: 2095, YearStart: "Apr 14 2038", YearEnd: "Apr 14 1939" },
            { CYear: 2096, YearStart: "Apr 15 2039", YearEnd: "Apr 12 1940" },
            { CYear: 2097, YearStart: "Apr 13 2040", YearEnd: "Apr 13 1941" },
            { CYear: 2098, YearStart: "Apr 14 2041", YearEnd: "Apr 13 1942" },
            { CYear: 2099, YearStart: "Apr 14 2042", YearEnd: "Apr 13 1943" },
            { CYear: 2100, YearStart: "Apr 14 2043", YearEnd: "Apr 12 1944" }
        ];
        return calYear;
    }
    ...
    private GetEngCalendarYearInfo(): Array<any> {
        let engYearsHash = [
            ...
            { engYear: 1908, yStartInBS: "1963-09-17", yEndInBS: "1964-09-17" },
            { engYear: 1909, yStartInBS: "1964-09-18", yEndInBS: "1965-09-17" },
            { engYear: 1910, yStartInBS: "1965-09-18", yEndInBS: "1966-09-16" },
            { engYear: 1911, yStartInBS: "1966-09-17", yEndInBS: "1967-09-16" },
            { engYear: 1912, yStartInBS: "1967-09-17", yEndInBS: "1968-09-17" },
            { engYear: 1913, yStartInBS: "1968-09-18", yEndInBS: "1969-09-17" },
            { engYear: 1914, yStartInBS: "1969-09-18", yEndInBS: "1970-09-16" },
            { engYear: 1915, yStartInBS: "1970-09-17", yEndInBS: "1971-09-16" },
            { engYear: 1916, yStartInBS: "1971-09-17", yEndInBS: "1972-09-17" },
            { engYear: 1917, yStartInBS: "1972-09-18", yEndInBS: "1973-09-17" },
            { engYear: 1918, yStartInBS: "1973-09-18", yEndInBS: "1974-09-16" },
            { engYear: 1919, yStartInBS: "1974-09-17", yEndInBS: "1975-09-16" },
            { engYear: 1920, yStartInBS: "1975-09-17", yEndInBS: "1976-09-17" },
            { engYear: 1921, yStartInBS: "1976-09-18", yEndInBS: "1977-09-17" },
            { engYear: 1922, yStartInBS: "1977-09-18", yEndInBS: "1978-09-16" },
            { engYear: 1923, yStartInBS: "1978-09-17", yEndInBS: "1979-09-16" },
            { engYear: 1924, yStartInBS: "1979-09-17", yEndInBS: "1980-09-17" },
            { engYear: 1925, yStartInBS: "1980-09-18", yEndInBS: "1981-09-16" },
            { engYear: 1926, yStartInBS: "1981-09-17", yEndInBS: "1982-09-16" },
            { engYear: 1927, yStartInBS: "1982-09-17", yEndInBS: "1983-09-16" },
            { engYear: 1928, yStartInBS: "1983-09-17", yEndInBS: "1984-09-17" },
            { engYear: 1929, yStartInBS: "1984-09-18", yEndInBS: "1985-09-16" },
            { engYear: 1930, yStartInBS: "1985-09-17", yEndInBS: "1986-09-16" },
            { engYear: 1931, yStartInBS: "1986-09-18", yEndInBS: "1987-09-17" },
            { engYear: 1932, yStartInBS: "1987-09-18", yEndInBS: "1988-09-16" },
            { engYear: 1933, yStartInBS: "1988-09-17", yEndInBS: "1989-09-16" },
            { engYear: 1934, yStartInBS: "1989-09-17", yEndInBS: "1990-09-17" },
            { engYear: 1935, yStartInBS: "1990-09-18", yEndInBS: "1991-09-16" },
            { engYear: 1936, yStartInBS: "1991-09-17", yEndInBS: "1992-09-16" },
            { engYear: 1937, yStartInBS: "1992-09-17", yEndInBS: "1993-09-16" },
            { engYear: 1938, yStartInBS: "1993-09-17", yEndInBS: "1994-09-17" },
            { engYear: 1939, yStartInBS: "1994-09-18", yEndInBS: "1995-09-16" },
            { engYear: 1930, yStartInBS: "1995-09-17", yEndInBS: "1996-09-16" },
            //data below are verified and are correct.., but above this are not..
            ...
            { engYear: 2019, yStartInBS: "2075-09-17", yEndInBS: "2076-09-16" },
            { engYear: 2020, yStartInBS: "2076-09-17", yEndInBS: "2077-09-16" },
            { engYear: 2021, yStartInBS: "2077-09-17", yEndInBS: "2078-09-16" },
            { engYear: 2022, yStartInBS: "2078-09-17", yEndInBS: "2079-09-16" },
            { engYear: 2023, yStartInBS: "2079-09-17", yEndInBS: "2080-09-16" },
            { engYear: 2024, yStartInBS: "2080-09-17", yEndInBS: "2081-09-16" },
            ...
            { engYear: 2030, yStartInBS: "2086-09-17", yEndInBS: "2087-09-16" },
            { engYear: 2031, yStartInBS: "2087-09-17", yEndInBS: "2088-09-16" },
            { engYear: 2032, yStartInBS: "2088-09-17", yEndInBS: "2089-09-16" },
            { engYear: 2033, yStartInBS: "2089-09-17", yEndInBS: "2090-09-16" },
            { engYear: 2034, yStartInBS: "2090-09-17", yEndInBS: "2091-09-16" },
            { engYear: 2035, yStartInBS: "2091-09-17", yEndInBS: "2092-09-16" },
            { engYear: 2036, yStartInBS: "2092-09-17", yEndInBS: "2093-09-16" },
    ...
    private GetDaysInMonthOfNext13NepaliMonthsIncludingCurrentMth(bsYr: number): Array<number> {
        let nep13MonthsDays = [];
        //get month_days of currentYear.
        //every english year starts from 9th Nepali month: i.e. Poush so start from 9th i.e index=8.
        let currNepYrMonths = this.yr_mth[bsYr];
        ...
        let nextNepYrMonths = this.yr_mth[bsYr + 1];
